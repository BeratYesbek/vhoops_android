...
class RegisterActivity : AppCompatActivity() {
    ...
    fun btnRegister(view: View) {
        ...
        val userId = binding.editTextRegisterUserID.text.toString()
        ...
        if(password.equals(passwordAgain)){
            ...
            userManager.addData(User(firstName,lastName,email,userId,password)){ result ->

                if(result.success()){
                    userManager.createUser(User(firstName,lastName,email,userId,password)){ createResult ->
