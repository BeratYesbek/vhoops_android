...
import com.beratyesbek.Vhoops.Business.LuminosityAnalyzer
import com.beratyesbek.Vhoops.Fragment.CameraFragment
import java.io.File
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun runCameraFragment(bitmap: Bitmap){
        transaction = supportFragmentManager.beginTransaction()
        transaction.setCustomAnimations(R.anim.fade_in_anim, R.anim.slide_out_anim)
        transaction.replace(R.id.frameLayout_camera_activity, CameraFragment(bitmap))
        transaction.commit()
    }
